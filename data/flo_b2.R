## Script qui édite les dynamiques d'inflorescences issues du dataset 1 pour le bloc 2
...
# write.csv(floraison2017_omit, file = "2017_bursts_death_bloc2.csv")
...
# write.csv(inflos1, file = "2017_inflos_dataset1_bloc2.csv")
...
# write.csv(bursts_death, file = "2017_bursts_death_bloc2.csv")