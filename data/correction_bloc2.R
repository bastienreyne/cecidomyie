## Script pour corriger les dynamiques du dataset 1 pour le bloc 2
...
dataset2 <- read_csv("2017_piege_bloc2.csv", col_names = TRUE)
...
dataset1_inflos <- read_csv("2017_inflos_dataset1_bloc2.csv")
...
dataset1_bursts_deads <- read_csv("2017_bursts_death_bloc2.csv")
...
# write.csv(bursts_echelle, file = "2017_bursts_echelle_bloc2.csv")
