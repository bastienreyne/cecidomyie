...
values_b1 <- as_tibble(cbind(date= days[-1], larves = rep(b1$larves/laps, laps)[-1], inflos_vivantes = approx(b1$date, b1$inflos_vivantes, days)$y[-1], inflos_mortes = rep(b1$inflos_mortes/laps, laps)[-1] )) %>% mutate(Bloc = factor("Bloc 1"), Sol = factor("Bache")) %>% mutate_at("date", as_date)
values_r1 <- as_tibble(cbind(date= days[-1], larves = rep(r1$larves/laps, laps)[-1], inflos_vivantes = approx(r1$date, r1$inflos_vivantes, days)$y[-1], inflos_mortes = rep(r1$inflos_mortes/laps, laps)[-1] )) %>% mutate(Bloc = factor("Bloc 1"), Sol = factor("Enherbement ras")) %>% mutate_at("date", as_date)
values_h1 <- as_tibble(cbind(date= days[-1], larves = rep(h1$larves/laps, laps)[-1], inflos_vivantes = approx(h1$date, h1$inflos_vivantes, days)$y[-1], inflos_mortes = rep(h1$inflos_mortes/laps, laps)[-1] )) %>% mutate(Bloc = factor("Bloc 1"), Sol = factor("Enherbement haut")) %>% mutate_at("date", as_date)
values_b2 <- as_tibble(cbind(date= days[-1], larves = rep(b2$larves/laps, laps)[-1], inflos_vivantes = approx(b2$date, b2$inflos_vivantes, days)$y[-1], inflos_mortes = rep(b2$inflos_mortes/laps, laps)[-1] )) %>% mutate(Bloc = factor("Bloc 2"), Sol = factor("Bache")) %>% mutate_at("date", as_date)
values_r2 <- as_tibble(cbind(date= days[-1], larves = rep(r2$larves/laps, laps)[-1], inflos_vivantes = approx(r2$date, r2$inflos_vivantes, days)$y[-1], inflos_mortes = rep(r2$inflos_mortes/laps, laps)[-1] )) %>% mutate(Bloc = factor("Bloc 2"), Sol = factor("Enherbement ras")) %>% mutate_at("date", as_date)
values_h2 <- as_tibble(cbind(date= days[-1], larves = rep(h2$larves/laps, laps)[-1], inflos_vivantes = approx(h2$date, h2$inflos_vivantes, days)$y[-1], inflos_mortes = rep(h2$inflos_mortes/laps, laps)[-1] )) %>% mutate(Bloc = factor("Bloc 2"), Sol = factor("Enherbement haut")) %>% mutate_at("date", as_date)
