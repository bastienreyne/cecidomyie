## Script qui effectue des simulations in silico / version congres ISEM2019
...
source("/home/bastien/cecidomyie/model_R/plot_res_IsG_ISEM.R")
#source("/home/bastien/cecidomyie/model_R/plot_res.R")
# source("D:/Mes donnees/GitHub_Bastien/cecidomyie-master/model_R/objectif.R")
# source("D:/Mes donnees/GitHub_Bastien/cecidomyie-master/model_R/model_new.R")
# source("D:/Mes donnees/GitHub_Bastien/cecidomyie-master/model_R/plot_res_IsG_ISEM.R")
...
# Creation de dynamiques d'inflos ---------------------------------------
...
#plot_inflos(inflos_obs,inflosCDE)                    # plot pour ppt ISEM2019
#plot_inflos(cbind(fB1,fB1,fB1),cbind(fB2,fB2,fB2))   # plot pour ppt ISEM2019


# Definition des parametres du modele (cf rapport Bastien) -----------------------
...
# 1/ Simulations pour expees virtuelles : effet lambda & stock------------

# hyp: facteurs environnementaux qui peuvent varier d'un verger à l'autre
#      traduit la pression à laquelle est soumise le verger
#      Modification des paramètres lambda et stock de + ou - 50%
...
# 2/ Simulations pour expees virtuelles : effet dynamique inflos -----------
