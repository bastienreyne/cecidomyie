...
objectif_v2 <- function(x, ma.fonction){
    larves_estimees <- dynamiques(x[1], x[2], 1, 0, x[3], inflos)
    # index <- 13:80
...
round2 <- nsga2(objectif_v2, 3, 3, my.mae, lower.bounds = rep(0, 3), upper.bounds = c(0.1, 0.5, 0.2),
